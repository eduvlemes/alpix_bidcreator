        ...
        <div class="container mt-5 pt-5">
            ...
            <div class="row pb-5 mb-5">
                ...
                <div class="col-md-8 offset-md-1 termos">
                    ...
                    <p><b>2. Materiais adicionais</b> tais como fontes pagas, fotos ou ferramentas de terceiros, não estão incluídos no preço. Se tais despesas surgirem, serão discutidas com o cliente antes de fazer qualquer compra.</p>
                    <p><b>3. Prazos.</b> O prazo total para todo o projeto é previsto para até X semanas. Quando solicitado aprovação visual de páginas ou qualquer elemento do projeto, o prazo fica pausado não contando assim o tempo de espera no prazo total até o retorno do cliente com aprovação ou solicitação de ajustes;</p>
                    ...
                    <p><b>5. O cliente é dono de todo o trabalho produzido. </b>A criação feita pela contratada e todos os direitos de propriedade intelectual associados a ela são repassados ao cliente depois que a contratada tiver sido paga integralmente pelos serviços prestados.</p>
